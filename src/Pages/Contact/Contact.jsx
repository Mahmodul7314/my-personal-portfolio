...
const Contact = () => {
    ...
    return (
    <div >
    <div className="lg:pl-[36rem] pl-[10rem] py-14 md:pl-[20rem]"><button className=" border-solid border-gray-700 px-4 py-2 border-2 text-xl font-extrabold flex justify-center">Contact</button>
    </div>
   <div className='lg:flex-row lg:flex md:flex-col flex-col justify-center gap-10  px-20 md:mb-8'>
   <div className='lg:w-1/2 w-full lg:shadow-md md:py-8 md:border md:border-green-300 md:px-8'>
    ...
    <div className='lg:w-1/2 w-full border border-green-300 shadow-md py-8'>
