    ...
    return (
        <div className="bg-green-50">
            <div className="lg:h-[80vh] md:h-[160vh] h-[180vh] px-10 w-3/2 lg:flex-row flex flex-col lg:justify-around">
                ...
                <h2 className="text-5xl font-bold flex items-center">Hi! I am Mahmodul <span className="pl-6"><img className="w-12 h-12" src="../../../public/wave.png" alt="" /></span></h2>
                ...
                <div className="lg:px-0 px-14">
                 <img className="lg:w-[28rem] rounded-full bg-green-300 p-2 lg:h-[30rem]" src="../../../public/profile.png" alt="" />
                </div>
            </div>
        </div>
    );
